										...
										<ul class="pager">
											<c:if test="${totalPage>=2 }">
												<c:if test="${totalPage-1>=page}">
													<li><a
														href="${pageContext.request.contextPath}/testnoteAction/queryTestonteStu.do?page=${page+1 }">下一页</a></li>
												</c:if>
												...
												<c:forEach begin="${page-2<0?1:page-2}"
													...
													<c:if test="${v>0 and v<totalPage+1 }">
														<li><a
															href="${pageContext.request.contextPath}/testnoteAction/queryTestonteStu.do?page=${v }">${v }</a></li>
													</c:if>
												</c:forEach>
												<c:if test="${page-1>=1}">
													<li><a
														href="${pageContext.request.contextPath}/testnoteAction/queryTestonteStu.do?page=${page-1 }">上一页</a></li>
												</c:if>
												<c:if test="${1==page}">
													<li><a>上一页</a></li>
												</c:if>
