...
<body>
					...
					<div class="card-body">
						...
						<form id="submitFrom" class="form-horizontal" action="#" method="post"
							...
							<div class="form-group">
								<label class="col-xs-12" for="example-text-input">教师编号</label>
								<div class="col-xs-12">
							...
							<div class="form-group">
								<label class="col-xs-12" for="example-text-input">教师姓名</label>
								<div class="col-xs-12">
									<input class="form-control" type="text"
										id="tname" name="tname"
										placeholder="姓名..">
	...
	<script type="text/javascript">
		function Btnclick(){
			...
			var verifyUrl='<%=request.getContextPath()%>'+'/teacherAction/addTea.do';
					$.ajax({
						type : 'post',
						url : verifyUrl,
						data : params,
